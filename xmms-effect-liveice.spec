...
LiveIce XMMS jest wtyczką dla XMMS-a, która wysyła strumienie po IceCast
i zapewnia ograniczony zestaw funkcji podobnych do tych, które daje
liveice. LiveIce XMMS nie ma wielu funkcji pełnej wersji liveice, ale
zawiera funkcje potrzebne do dostarczania strumienia z XMMS-a. Większość
funkcji jest dostępna z GUI zaprojektowanego przez Petera z zespołu
XMMS.
